...
<script>
    ...
    var tableName = "dictionaryShangjijiluZhuangtai";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "shangjijilu_zhuangtai_types";
            data["dicName"] = "状态";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"shangjijilu_zhuangtai_types"}, (res) => {
                if(res.code == 0){
