...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">机器列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //价格
            var beizhu1111Cell = document.createElement('td');
            beizhu1111Cell.innerHTML = item.beizhu1111;
            row.appendChild(beizhu1111Cell);
            ...
            if(window.sessionStorage.getItem("role") == '用户' && item.jiqiShiyongTypes ==1){
                //修改按钮
                var shangjiBtn = document.createElement('button');
                var shangjiAttr = 'shangji(' + item.id + ')';
                shangjiBtn.setAttribute("type", "button");
                shangjiBtn.setAttribute("class", "btn btn-warning btn-sm");
                shangjiBtn.setAttribute("onclick", shangjiAttr);
                shangjiBtn.innerHTML = "上机";
                btnGroup.appendChild(shangjiBtn);
            }
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jiqi/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //上机
        function shangji(id) {
            http("jiqi/shangji?id="+id, "GET", {}, (res) => {
                if(res.code == 0){
                    alert("上机成功");
                    getDataList();
                }else{
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiqi", "addjiqi");
            window.location.href = "add-or-update.jsp"
        }
