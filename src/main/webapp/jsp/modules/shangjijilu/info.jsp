            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">上机记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="jiqiUuidNumber" name="jiqiUuidNumber" class="form-control"
                                                   v-model="ruleForm.jiqiUuidNumber" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiqiQuValue" name="jiqiQuValue" class="form-control"
                                               v-model="ruleForm.jiqiQuValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="jiqiAddress" name="jiqiAddress" class="form-control"
                                                   v-model="ruleForm.jiqiAddress" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiqiShiyongValue" name="jiqiShiyongValue" class="form-control"
                                               v-model="ruleForm.jiqiShiyongValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="jiqiId" name="jiqiId" v-model="ruleForm.jiqiId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shangjijiluUuidNumber" name="shangjijiluUuidNumber" class="form-control"
                                               v-model="ruleForm.shangjijiluUuidNumber" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>上机时间</label>
                                        <input style="width: 450px" id="shangjiTime" name="shangjiTime" class="form-control"
                                               v-model="ruleForm.shangjiTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>下机时间</label>
                                        <input style="width: 450px" id="xiajiTime" name="xiajiTime" class="form-control"
                                               v-model="ruleForm.xiajiTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="huafeijine" name="huafeijine" class="form-control"
                                               v-model="ruleForm.huafeijine" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>状态</label>
                                    <input style="width: 450px" id="shangjijiluZhuangtaiValue" name="shangjijiluZhuangtaiValue" class="form-control"
                                           v-model="ruleForm.shangjijiluZhuangtaiValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shangjijilu/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.jiqiContent != null && ruleForm.jiqiContent != 'null' && ruleForm.jiqiContent != '') {
            var jiqiContentUeditor = UE.getEditor('jiqiContentEditor');
                jiqiContentUeditor.ready(function () {
                    ...
                    jiqiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
