...
<body>
    <div class="modal fade" id="chongzhiModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                    <h5 class="modal-title" id="plusOrReduce${entity}KucunNumberTitle">充值</h5>
                ...
                <div class="modal-body">
                    ...
                    充值金额:<input type="number" id="chongzhiNumber" style="width: 140px;" class="form-control form-control-sm"
                           placeholder="充值金额" aria-controls="tableId">
                    <input type="hidden" id="chongzhiId">
                    <input type="hidden" id="yuanxianNumber">
                </div>
                <%-- 模态框按钮 --%>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" onclick="chongzhi()" class="btn btn-primary">充值</button>
                </div>
            </div>
        </div>
    </div>
...
<%--//充值
function chongzhiModel(id) {

$("#chongzhiNumber").val(100);
$("#chongzhiId").val(id);
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            if(window.sessionStorage.getItem("role") == '管理员'){
                //充值
                var chongzhiBtn = document.createElement('button');
                var chongzhiAttr = "chongzhiModel(" + item.id +','+item.newMoney+ ')';
                chongzhiBtn.setAttribute("type", "button");
                chongzhiBtn.setAttribute("class", "btn btn-info btn-sm");
                chongzhiBtn.setAttribute("onclick", chongzhiAttr);
                chongzhiBtn.innerHTML = "充值";
                btnGroup.appendChild(chongzhiBtn);
            }
        ...
        //充值
        function chongzhiModel(id,yuanxianNumber) {

            $("#chongzhiNumber").val(100);
            $("#yuanxianNumber").val(yuanxianNumber);
            $("#chongzhiId").val(id);
            $('#chongzhiModel').modal('show');
        }
        //充值
        function chongzhi() {
            if(Number($("#chongzhiNumber").val()) <0){
                alert("充值金额必须大于0");
                return false;
            }
            let newMoney = (Number($("#yuanxianNumber").val()) + Number($("#chongzhiNumber").val())*2);
            let data={
                id:$("#chongzhiId").val(),
                newMoney:newMoney,
            }
